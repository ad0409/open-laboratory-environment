...
if sys.version_info.major < 3:  # checking if python version > 3 is used
...
def schedule_1(command_list=5):
    ...
    time.sleep(operation_time_move_printer_y)  # sleeping required time until movement is done
    ...
    time.sleep(operation_time_move_printer_x)  # sleeping required time until movement is done
